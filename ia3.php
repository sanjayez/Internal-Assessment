<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO ia3 (id, name, sem, one, two, three, four, five, six) VALUES ('','$name','$sem','$one','$two','$three','$four','$five','$six')";
...
<body>
    ...
    <div class="box" id="down">
        ...
        <form action="" method = "post" enctype="multipart/form-data"> 
            ...
            <div class="inputBox">
                    <input type="number" name="one" required="">
                    <label>subject one</label>
            </div>

             <div class="inputBox">
                    <input type="number" name="two" required="">
                    <label>subject two</label>
            </div>

             <div class="inputBox">
                    <input type="number" name="three" required="">
                    <label>subject three</label>
            </div>

             <div class="inputBox">
                    <input type="number" name="four" required="">
                    <label>subject four</label>
            </div>

            <div class="inputBox">
                    <input type="number" name="five" required="">
                    <label>subject five</label>
            </div>

            <div class="inputBox">
                    <input type="number" name="six" required="">
